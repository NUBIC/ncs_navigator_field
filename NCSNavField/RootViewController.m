...
//    for (UIView* v in self.splitViewController.view.subviews) {
//        NSLog(@"sv: %@", v);
...
//    }
//    
//    NCSNavFieldAppDelegate* d = UIAppDelegate;
//    d.window.backgroundColor = [UIColor redColor];
//                 
//    for (UIView* v in d.window.subviews) {
...
//    }
//    
//    d.rootViewController.view.backgroundColor = [UIColor redColor];
//    for (UIView* v in d.rootViewController.view.subviews) {
//        v.backgroundColor = [UIColor redColor];
//        for (UIView* v2 in v.subviews) {
//            v2.backgroundColor = [UIColor redColor];
//            for (UIView* v3 in v2.subviews) {
...
//    d.detailViewController.view.backgroundColor = [UIColor redColor];
//    UIView* n = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 1000, 1000)];
//    n.backgroundColor = [UIColor redColor];

//    [d.detailViewController.view sendSubviewToBack:n];
//    for (UIView* v in d.detailViewController.view.subviews) {
//        NSLog(@"v: %@", v);
//        v.opaque = YES;
//        v.backgroundColor = [UIColor redColor];
//        for (UIView* v2 in v.subviews) {
